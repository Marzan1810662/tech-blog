...
const Dashboard = () => {
    return (
        <div className="drawer drawer-mobile lg:relative">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu w-80 py-4 text-primary-content bg-secondary relative">
                    ...
                    <li className='border-2 border-secondary-focus w-full absolute bottom-8'><Link to='/'>Go to Home</Link></li>
                </ul>
            </div>
        </div>
    );
